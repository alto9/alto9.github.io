...
The Kube9 Operator is an open source Kubernetes operator that runs inside your cluster. It performs Well-Architected Framework validation, event tracking, and cluster insights. All operator features are completely free and open source.
...
4. **VS Code extension reads CRDs** - Displays insights in your IDE

## Installation

```bash
# Using Helm (recommended)
helm repo add alto9 https://alto9.github.io/charts
helm install kube9-operator alto9/kube9-operator
